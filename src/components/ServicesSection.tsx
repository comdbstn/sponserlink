    ...
    <div className="card group relative overflow-hidden">
      ...
      <div className="relative z-10 p-8 transition-all duration-500 group-hover:translate-y-[-8px]">
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="font-playfair text-xl mb-4 text-[var(--primary)] group-hover:text-white transition-colors duration-500" style={{ fontWeight: 'var(--font-weight-bold)' }}>{title}</h3>
