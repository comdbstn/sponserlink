const ProcessStep = ({ number, title, description }: { 
  ...
  return (
    <div className="relative flex flex-col items-center text-center">
      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[var(--primary)] to-[var(--primary-light)] text-white flex items-center justify-center text-3xl mb-6 shadow-lg z-10" style={{ fontWeight: 'var(--font-weight-bold)' }}>
        {number}
      </div>
      <h3 className="font-playfair text-xl mb-4 text-[var(--text-dark)]" style={{ fontWeight: 'var(--font-weight-bold)' }}>{title}</h3>
