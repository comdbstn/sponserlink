      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-gray-600 mt-2 max-w-md">
              행사와 스폰서를 연결해주는, 스폰서링크는 이벤트 주최자와 스폰서 기업을 연결하는 혁신적인 매칭 플랫폼입니다.
            </p>
          </div>
          
          <div className="flex flex-wrap gap-8">
            <div>
              <h4 className="font-medium text-gray-900 mb-3">서비스</h4>
              <ul className="space-y-2">
                <li><Link href="/services/education" className="text-gray-600 hover:text-gray-900">국비교육</Link></li>
                <li><Link href="/services/contest" className="text-gray-600 hover:text-gray-900">공모전/대외활동</Link></li>
                <li><Link href="/services/recruitment" className="text-gray-600 hover:text-gray-900">채용/인턴</Link></li>
                <li><Link href="/services/campus" className="text-gray-600 hover:text-gray-900">캠퍼스 마케팅</Link></li>
              </ul>
            </div>
            
            <div>
              <h4 className="font-medium text-gray-900 mb-3">회사</h4>
              <ul className="space-y-2">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="mailto:contact@sponsorlink.com" className="text-gray-600 hover:text-gray-900">
                    contact@sponsorlink.com
                  </a>
                </li>
                <li>
                  <a href="tel:01012345678" className="text-gray-600 hover:text-gray-900">
                    010-1234-5678
                  </a>
                </li>
              </ul>
        ...
        <div className="mt-10 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm mb-4 md:mb-0">
            © {currentYear} SponsorLink. All rights reserved.
          </p>
